...
public class BaseItem : IBaseItem
{
    ...
    public unsafe bool Use()
    {
        ...
        {
            return ActionManager.Instance()->UseAction(ActionType.Item, ID + 1000000, Player.Object.EntityId, A4);
        }

        return ActionManager.Instance()->UseAction(ActionType.Item, ID, Player.Object.EntityId, A4);
    }
